...
% HHO. 13.Change the random point A to the average X.
function [best_pos,convergence_curve]=BSHHSMA_22(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('BSHHSMA_22 is now tackling your problem')

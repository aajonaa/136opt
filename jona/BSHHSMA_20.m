...
% HHO.
function [best_pos,convergence_curve]=BSHHSMA_20(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('BSHHSMA_20 is now tackling your problem')
...
%     E1=2*(1-(FEs/Max_FEs)); % factor to show the decreaing energy of rabbit
    ...
    for i=1:N
        ...
        % Exploration and Exploitation phase.
            ...
            % Eq.(2.2) p is between [0, 1]. Decreasing from 1 to 0. 1-->0
            % P is a threshold.

%% Slime Mold Algorithm modified by Jona 2024-1-5.
%1. Combined BSA
%2. Use phase_rate to control the portion of the BSA and SMA.
function [best_pos,Convergence_curve]=BSSMA1_5(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('BSSMA1_5 is now tackling your problem')

%% Slime Mold Algorithm modified by Jona 2023-11-21.
% Use normal BSA select II with DIM_RATE decrease and no rand.
function [best_pos,Convergence_curve]=BS_SMA_28_3_2(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('BS_SMA_28_3_2 is now tackling your problem')

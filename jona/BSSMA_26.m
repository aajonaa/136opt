...
% Modified by Jona at 2023-11-11, I use the mutation and crossover at the
...
function [best_pos,convergence_curve]=BSSMA_26(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('BSSMA_26 is now tackling your problem')

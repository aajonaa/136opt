% Slime Mold Algorithm modified by Jona 2023-11-15.
% 1. sine map to get better initilized population.
function [best_pos,convergence_curve]=SMA_sine(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('SMA_sine is now tackling your problem')

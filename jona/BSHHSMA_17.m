...
% to 15.
function [best_pos,convergence_curve]=BSHHSMA_19(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('BSHHSMA_19 is now tackling your problem')
...
%         fitness_offsprings = inf * ones(1, 5);
        fitness_offsprings = inf * ones(1, 15);
%         for i = 1:5
...
%             end
        ...
        bs_X_fitness = reshape(bs_X_fitness, [1, 15]);

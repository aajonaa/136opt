...
% Use normal BSA select II with DIM_RATE decrease.
function [best_pos,Convergence_curve]=BS_SMA_28_3(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('BS_SMA_28_3 is now tackling your problem')

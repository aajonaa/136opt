...
% best positition. 4.Cancel the elite opposition based learning.
function [best_pos,convergence_curve]=HHSMA_9(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('HHSMA_9 is now tackling your problem')
    ...
    for i=1:N
        ...
        %             elseif q>=0.5   % perch on a random tall tree (random site inside group's home range)
                ...
                % Exploitation status.
                    ...
                    elseif r<0.5 && abs(Escaping_Energy)<0.5 % Hard besiege % rabbit try to escape by many zigzag deceptive motions

...
% opposition based learning to avoid stuck in local optimal.
function [best_pos,convergence_curve]=rOBLHHSMA_3(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('rOBLHHSMA_3 is now tackling your problem')

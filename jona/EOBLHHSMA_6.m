...
% Destination fitness in order to draw it in convergence_curve.
function [best_pos,convergence_curve]=EOBLHHSMA_6(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('EOBLHHSMA_6 is now tackling your problem')
...
%     %%%%%%%%%%
    ...
    fTemp = fobj(Temp);
    FEs = FEs + 1;
    if fTemp<Destination_fitness
        Destination_fitness = fTemp;
        best_pos = Temp;
    end

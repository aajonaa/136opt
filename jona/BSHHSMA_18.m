...
% individuals.9.Only use BSA in the rear part(1/2) of the evalution test.
% 8.Change the rear part to be the 1/3.
function [best_pos,convergence_curve]=BSHHSMA_18(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('BSHHSMA_18 is now tackling your problem')
...
while  FEs < Max_FEs
    ...
    %     end
        ...
        bs_X_fitness = reshape(bs_X_fitness, [1, 5]);

%% Slime Mold Algorithm modified by Jona 2023-12-9.
%1. Combined BSA
%2. Use phase_rate to control the portion of the BSA and SMA.
function [best_pos,Convergence_curve]=golden_BSSMA(N,Max_FEs,lb,ub,dim,fobj)
tic
disp('golden_BSSMA is now tackling your problem')
...
while  FEs < Max_FEs
    ...
    if FEs < Max_FEs * PHASE_RATIO
        ...
        [minimumFitness, ind] = min(AllFitness);

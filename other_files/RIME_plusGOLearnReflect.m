function [Best_rime,Convergence_curve]=RIME_plusGOLearnReflect(N,MaxFEs,lb,ub,dim,fobj)
% RIME enhanced with GO learning + reflection miniblocks (no random accept)
% Guided by ablation: keep soft-rime; disable puncture; add GO learn+reflect; allow mutation

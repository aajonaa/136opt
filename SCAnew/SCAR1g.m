function [Destination_position,Convergence_curve]=SCAr12CLS(N,Max_iteration,lb,ub,dim,fobj)
tic
...
while  FEs<=Max_iteration
    ...
    % Eq. (3.4)
    a =4*(1-FEs/Max_iteration) ;
    r1=a*(1-1.7^(FEs/Max_iteration-1));% r1 decreases linearly from a to 0

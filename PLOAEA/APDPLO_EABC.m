...
% Swarm and Evolutionary Computation 94 (2025) 101890 Available online 24 February 2025 2210-6502/© 2025 Elsevier B.V.
...
function [best_pos, Convergence_curve] = APDPLO_EABC(N, MaxFEs, lb, ub, dim, fobj)
    %% Initialization
    FEs = 0;
    it = 1;
...
% Levy and initialization functions (unchanged)
function o = Levy(d)
    beta = 1.5;
